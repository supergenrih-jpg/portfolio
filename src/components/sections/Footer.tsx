  ...
  return (
    <footer ref={ref} style={{ backgroundColor: 'var(--bg-elevated)' }}>
      ...
      >
        ...
        {/* Copyright */}
        <div
          className="max-w-6xl mx-auto mt-6 pt-6 border-t flex flex-col md:flex-row items-center justify-between gap-2 text-xs"
          style={{ borderColor: 'var(--border-glass)', color: 'var(--text-muted)' }}
        >
          <span>© 2026 genrih · All rights reserved</span>
          <span>Built with Next.js, Three.js, and ☕</span>
        </div>
      </motion.div>
    </footer>
  );
